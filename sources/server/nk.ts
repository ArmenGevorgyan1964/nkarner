class nk {
    ...
    showList = () => "<ul><li>id: "+this.id+" </li><li>CD_Num: "+ this.CD_Num +"</li> <li>Filename: " + this.Filename + "</li></ul>";
    inConsoleTest = () => console.log("id: "+this.id+", CD_Num: "+ this.CD_Num +", Filename: " + this.Filename );
}