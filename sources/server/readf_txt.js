...
class nkar {
    constructor(oneline) {
        ...
        this.addIndex = (elSearchClient, indexName, idVal, typeName) => {
        ...
        this.showList = () => `id:  ${this.id} , CD_Num: <b> ${this.CD_Num}</b>, Filename: ${this.Filename}`;
        this.showTable = () => `<table border="1">
    <tr>
    ...
    `;
        this.inConsoleTest = () => console.log("id: " + String(this.id) + ", CD_Num: " + String(this.CD_Num) + ", Filename: " + String(this.Filename));
